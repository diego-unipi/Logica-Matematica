...
\begin{proof}
    ...
    \begin{itemize}
        ...
        e lo dimostriamo usando l'induzione metateorica su $b$. Se $b = 0$, allora $a + 0 = a$, e quindi $c = a$, per $\mathsf{Q3}$ vale che $\mathsf{Q} \vdash \ol a + \ol 0 = \ol a$, e per definizione di numerale $\ol 0 = 0$, quindi vale la tesi.
        Assumiamo che $a + b = c \implies Q \vdash \ol a + \ol b = \ol c$, e vediamo che $a + s(b) = c$, allora $\mathsf{Q} \vdash \ol a + \ol{b+1} = \ol c$, ora per definizione di numerale $\ol{b+1} = \ol b + \ol 1$, e per $\mathsf{Q4}$ vale che $\mathsf{Q} \vdash \ol a + \ol{b+1} = s(\ol a + \ol b)$, 
