...
\begin{proof}
    ...
    \begin{align*}
        F(\ulcorner F \urcorner) & = s_n^1(\ulcorner g \urcorner, \ulcorner F \urcorner) \\
                                 & = u_n(\ulcorner g \urcorner, \ulcorner F \urcorner, \mathbf y) \\
...
Morale: essere dominio, immagine o luogo di zero di una funzione ricorsiva parziale sono tutte la stessa cosa, e questa è la nozione di semidecidibilità.
