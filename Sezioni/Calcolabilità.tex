...
\begin{remark}[Corrispettivo insiemistico della chiusura delle classi aritmetiche]
    ...
    \begin{itemize}
        ...
        \item se $R \subseteq \NN^{k+1}$ di classe $\Sigma_n^0$ e $t(\mathbf x)$ è un termine aritmetico, allora $\{\mathbf x \in \NN^k : \forall y \leq t(\mathbf x) \; (\mathbf x, y) \in R\}$ è di classe $\Sigma_n^0$; questa operazione è chiamata \vocab{proiezione universale},
    \end{itemize}
