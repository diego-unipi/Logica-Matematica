...
\begin{proof}
    ...
    \begin{itemize}
        ...
        ovvero è sufficiente controllare che per tutti gli $i < z$ vale $T(\mathbf x,i) = 0$, e questo è precisamente il luogo di zero del predicato PR che conta gli 
        elementi, sotto un certo valore di un altro predicato:
        \[ \{ \#\{i < z : T(\mathbf x,i) = 0\} = 0 \} = R \]
    \end{itemize}
\end{proof}
