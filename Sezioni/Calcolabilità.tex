...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \end{cases} \]
        dove ``$\mathbf x$'' è in realtà $(\nth(n,0), \ldots, \nth(n,k-1))$, per cui $g$ è PR. Inoltre $R = \Img g$, infatti $\mathbf x \in R$ se e solo se $f(\mathbf x) \ne \bot$,
        se e solo se $\exists n \; T_k(\ulcorner f \urcorner, \mathbf x, n) = 0$, se e solo se $\exists n \; g(n) = \mathbf x$. Se $R = \varnothing$, allora è ricorsivamente enumerabile per definizione.
