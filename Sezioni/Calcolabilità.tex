...
\begin{proof}
    ...
    \end{align*}
    dove aggiungiamo gli altri $\textsf{For}$ ricorsivamente perché la formula codificata da $n$ è una formula se e solo se le sottoformule codificate dai sotto-codici sono formule,
    ed ovviamente, essendo $\textsf{For}$ un'indicazione finita di predicati PR, $\textsf{For}$ è PR.
\end{proof}
...
\begin{proof}
    ...
    \[ \textsf{Sub}(n,i,x) := \begin{cases}
        ...
        \langle \#=, \textsf{Sub}(a,i,x), \textsf{Sub}(b,i,x) \rangle & \text{se $n = \langle\#=,a,b\rangle$} \\
        \langle \#\neg, \textsf{Sub}(a,i,x) \rangle & \text{se $n = \langle\#\neg,a\rangle$} \\
        \langle \#\to, \textsf{Sub}(a,i,x), \textsf{Sub}(b,i,x) \rangle & \text{se $n = \langle\#\to,a,b\rangle$} \\
        \langle \#\forall, j, \textsf{Sub}(a,i,x) \rangle & \text{se $n = \langle\#\forall,j,a\rangle$ e $j \ne i$} \\
    \end{cases} \]
\end{proof}
