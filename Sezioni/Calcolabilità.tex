...
\begin{proof}
    Tale insieme è proprio l'insieme dei codici delle formule in $\Th(\NN;L_{\text{arit}})$, se fosse ricorsivamente assiomatizzabile contraddirebbe il primo teorema di incompletezza.
\end{proof}
