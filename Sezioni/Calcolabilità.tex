...
\begin{proof}
    ...
    ovvero $\texttt{n}$ rappresenta il numero di passi in cui la TM termina a partire da input codificato da $c$. E siamo alla fine perché ora per 
    ...
    \end{cases}\]
    che è PR, e quindi $u$ si definisce componendo $\texttt{conta\_uni}$ con la funzione scritta sopra.
\end{proof}
...
\begin{corollary}[Forma normale per le funzioni ricorsive]
    ...
    \[ \forall x_1, \ldots, x_k \; f(x_1, \ldots, x_k) \ne \bot \iff \exists n \; \mu_n(T_k(x_1, \ldots, x_k, \ulcorner f \urcorner, n) = 0) \]
    e se questo avviene allora:
    \[ f(x_1, \ldots, x_k) = U(\mu_n(T_k(x_1, \ldots, x_k, \ulcorner f \urcorner, n) = 0)) \]
    ovvero se $x_1, \ldots, x_k$ sono nel dominio di $f$, allora $f(x_1, \ldots, x_k)$ è proprio $U$ applicato al minimo $n$ per cui $T_k$ è 0. 
\end{corollary}
