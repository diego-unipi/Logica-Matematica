...
\begin{soln}
    ...
    Infine si osserva che $l$ è il bound giusto sotto cui controllare perché $\cons(x,y) \geq \max\{x,y\}$, quindi ha senso contare fino a $l$ per verificare se si trova 0 come seconda componente di $\cons$.\\
