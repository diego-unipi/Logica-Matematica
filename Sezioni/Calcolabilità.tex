...
Tale funzione è biunivoca tra le coppie $(x,y) \in \NN^2$ e i numeri naturali maggiori di 1 - fa comodo avere un null point, e quindi non vogliamo che $(0,0)$ venga codificato da $0$.
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \begin{proof}
            ...
            con $c \blacktriangleright x - t y_1 \ldots y_k t f(t, y_1, \dots, y_k) x - (t + 1) y_1 \ldots y_k$, ora copiamo $t$ in fondo e applichiamo $s$, per ottenere $t+1$, fatto questo ricopiamo $t+1$ e $y_1,\dots,y_k$ in fondo alla lista, e poi applichiamo $f$:
            \begin{multline*} c \to \push_{2k+3,k+2} \to \exec_{2k+4,k+2}s \to \push_{2k+4,k+3} \to \\ \to \push_{2k+5,k+4} \to \ldots \to \push_{3k+4,2k+3} \to \to \exec_{3k+5,2k+3}f \to d \end{multline*}
